...
async function sendUploadedAnswersMail(email, enterpriseName){
    ...
    from: 'Pruebas', // sender address
    to: email, // list of receivers
    subject: `${enterpriseName}, Un usuario subió un archivo con las respuestas a una vacante`, // Subject line
...
async function sendNotifyNewUserMail(email, cadena){
    ...
    from: 'Bolsa de Trabajo', // sender address
    to: email, // list of receivers
    subject: `Se acaba de registrar un usuario`, // Subject line
    text: cadena, // plain text body
...
async function sendNotifyNewOfferMail(email, cadena){
    ...
    from: 'Bolsa de Trabajo', // sender address
    to: email, // list of receivers
    subject: `Hay una nueva oferta de trabajo disponible`, // Subject line
    text: cadena, // plain text body
    html: cadena // html body
    });
...
module.exports = {
    ...
    sendUploadedAnswersMail,
    sendNotifyNewUserMail,
    sendNotifyNewOfferMail
}